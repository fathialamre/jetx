...
///
/// ```dart
/// class SomeController with JetLifeCycle {
///   SomeController() {
///     configureLifeCycle();
///   }
/// }
...
// that inherits JetLifeCycle.""";
//     }
//   }
}

/// Allow track difference between JetxServices and JetxControllers
mixin JetxServiceMixin {}

/// Unlike JetxController, which serves to control events on each of its pages,
/// JetxService is not automatically disposed (nor can be removed with
/// Jet.delete()).
...
/// it is Jet.reset().
abstract class JetxService with JetLifeCycleMixin, JetxServiceMixin {}
