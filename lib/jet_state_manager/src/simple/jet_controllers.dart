...
///
/// Extend this class to create a controller that can be used with JetX's
...
/// ```
// ignore: prefer_mixin
abstract class JetxController extends ListNotifier with JetLifeCycleMixin {
...
/// Example:
/// ```dart
/// class MyController extends JetxController with ScrollMixin {
///   @override
...
///
/// This class is a lightweight alternative to [JetxController] when you only
...
/// }
/// ```
abstract class StateController<T> extends JetxController with StateMixin<T> {}
...
///
/// This controller extends [JetxController] and implements [WidgetsBindingObserver]
...
/// }
/// ```
abstract class FullLifeCycleController extends JetxController
    with
        // ignore: prefer_mixin
