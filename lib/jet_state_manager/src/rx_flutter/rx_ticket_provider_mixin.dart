...
/// Used like `SingleTickerProviderMixin` but only with Jet Controllers.
/// Simplifies AnimationController creation inside JetxController.
///
/// Example:
///```
///class SplashController extends JetxController with
...
///  ...
/// ```
mixin JetSingleTickerProviderStateMixin on JetxController
...
/// Used like `TickerProviderMixin` but only with Jet Controllers.
/// Simplifies multiple AnimationController creation inside JetxController.
///
/// Example:
///```
///class SplashController extends JetxController with
...
///  ...
/// ```
mixin JetTickerProviderStateMixin on JetxController implements TickerProvider {
  Set<Ticker>? _tickers;
...
@Deprecated('use JetSingleTickerProviderStateMixin')
...
///  ...
/// ```
mixin SingleGetTickerProviderMixin on JetLifeCycleMixin
    implements TickerProvider {
  @override
