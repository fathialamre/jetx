...
extension JetNavigationExt on JetInterface {
  ...
  ///
  /// By default, JetX will prevent you from push a route that you already in,
  ...
  //     _jetxController.defaultPopGesture = defaultPopGesture;
  //   }
  //   if (defaultOpaqueRoute != null) {
  //     _jetxController.defaultOpaqueRoute = defaultOpaqueRoute;
  //   }
  //   if (defaultTransition != null) {
  //     _jetxController.defaultTransition = defaultTransition;
  //   }

  //   if (defaultDurationTransition != null) {
  //     _jetxController.defaultTransitionDuration = defaultDurationTransition;
  //   }
  // }
  ...
  ConfigData get _jetxController => JetRootState.controller.config;

  bool? get defaultPopGesture => _jetxController.defaultPopGesture;
  bool get defaultOpaqueRoute => _jetxController.defaultOpaqueRoute;

  Transition? get defaultTransition => _jetxController.defaultTransition;

  Duration get defaultTransitionDuration {
    return _jetxController.defaultTransitionDuration;
  }

  Curve get defaultTransitionCurve => _jetxController.defaultTransitionCurve;

  Curve get defaultDialogTransitionCurve {
    return _jetxController.defaultDialogTransitionCurve;
  }

  Duration get defaultDialogTransitionDuration {
    return _jetxController.defaultDialogTransitionDuration;
  }

  Routing get routing => _jetxController.routing;
  ...
  TDelegate? delegate<TDelegate extends RouterDelegate<TPage>, TPage>() =>
      _jetxController.routerDelegate as TDelegate?;
}
