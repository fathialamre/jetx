...
/// Handling mode when pushing routes that shouldn't be duplicated
enum PreventDuplicateHandlingMode {
  /// Removes pages until reaching the old route
  ...
  /// Guarantees only one route entry for each location
  reorderRoutes,
...
class JetPage<T> extends Page<T> {
  ...
  Route<T> createRoute(BuildContext context) {
    // Navigator 2.0 - create proper route
