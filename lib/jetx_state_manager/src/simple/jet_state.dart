...
typedef JetControllerBuilder<T extends JetLifeCycleMixin> = Widget Function(
    T controller);
...
//   T filter<T extends JetxController>(Object Function(T value)? filter) {
//     return Bind.of(this, filter: filter, rebuild: true);
//   }
// }

class JetBuilder<T extends JetxController> extends StatelessWidget {
  final JetControllerBuilder<T> builder;
  final bool global;
  final Object? id;
  final String? tag;
