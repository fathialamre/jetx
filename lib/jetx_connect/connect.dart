...
abstract class JetConnectInterface with JetLifeCycleMixin {
  List<JetSocket>? sockets;
  JetHttpClient get httpClient;
...
class JetConnect extends JetConnectInterface {
  JetConnect({
  ...
  JetHttpClient? _httpClient;
  List<JetSocket>? _sockets;
  bool withCredentials;

  @override
  List<JetSocket> get sockets => _sockets ??= <JetSocket>[];

  @override
  JetHttpClient get httpClient => _httpClient ??= JetHttpClient(
      userAgent: userAgent,
  ...
  JetSocket socket(
    ...
    final newSocket = JetSocket(_concatUrl(url)!, ping: ping);
